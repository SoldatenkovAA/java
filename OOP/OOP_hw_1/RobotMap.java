...
public class RobotMap {
    ...
    /**
     * 
     * @param length задается в клиентском коде, является ограничивающим значением
     *               при проверке длины массива с роботами
     */
    ...
    /* RobotMap - с заданным параметром количества роботов */
     ...
     * @param length - значение максимальной длины массива, контролируещее
     *               количество роботов
     */
    ...
    private void validateMap(int n, int m) {
        if (n < 0 || m < 0) {
            throw new IllegalStateException("Нельзя вводить отрицательное значение!");
        }
    }
